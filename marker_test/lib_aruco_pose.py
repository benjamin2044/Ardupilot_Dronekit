...
class ArucoSingleTracker():
    def __init__(self, id_to_find, marker_size, camera_matrix, camera_distortion,
                                          camera_size=[640,480], show_video=False):
...
if __name__ == "__main__":
    ...
    #calib_path  = "/home/pi/marker_test/camera_01/"
    calib_path  = "/home/pi/marker_test/camera_pi/"
    camera_matrix = np.loadtxt(calib_path+'cameraMatrix.txt', delimiter=',')
    camera_distortion = np.loadtxt(calib_path+'cameraDistortion.txt', delimiter=',')
    aruco_tracker = ArucoSingleTracker(id_to_find=72, marker_size=marker_size, show_video=True, camera_matrix=camera_matrix, camera_distortion=camera_distortion)
